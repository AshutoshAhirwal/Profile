    ...
    <section className={`section-layer ${status}`} id="about">
      ...
      <div className="container">
        <div className="bento-grid">
          <div className="bento-item large animate-fade-right" style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          ...
          <div className="bento-item animate-fade-up delay-200" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
          ...
          <div className="bento-item animate-fade-up delay-300" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            <h4 style={{ color: 'var(--accent-primary)', fontSize: '2.5rem', marginBottom: '8px' }}>5.1Y</h4>
            <p style={{ color: 'var(--text-muted)' }}>Experience</p>
          </div>

          <div className="bento-item wide animate-fade-up delay-400" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
