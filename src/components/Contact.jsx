  ...
  return (
    <section className={`section-layer ${status}`} id="contact">
      ...
      <div className="container" style={{ textAlign: 'center' }}>
        <h2 className="section-title animate-fade-up">Initiate Transmission</h2>
        <p className="animate-fade-up delay-200" style={{ color: 'var(--text-muted)', maxWidth: '600px', margin: '0 auto 40px' }}>
          Ready to help MNCs and innovative startups build the next generation of Drupal enterprise solutions.
        </p>
        
        <div className="social-links animate-pop-in delay-400" style={{ justifyContent: 'center', transform: 'scale(1.5)' }}>
        ...
        <div className="animate-fade-up delay-600" style={{ marginTop: '80px', fontFamily: 'monospace', fontSize: '0.7rem', color: 'var(--text-dim)' }}>
