  ...
  return (
    <section className={`section-layer ${status}`} id="projects">
      ...
      <div className="container">
        <h2 className="section-title animate-fade-up">Critical Infrastructure</h2>
        <div className="bento-grid" style={{ gridTemplateRows: 'auto' }}>
          <div className="bento-item wide animate-fade-up delay-100">
          ...
          <div className="bento-item animate-fade-up delay-200">
          ...
          <div className="bento-item animate-fade-up delay-300">
          ...
          <div className="bento-item large animate-pop-in delay-200" style={{ display: 'flex', flexDirection: 'column', gap: '16px', justifyContent: 'center' }}>
            <h4>Open Source</h4>
          ...
          <div className="bento-item animate-fade-up delay-400">
          ...
          <div className="bento-item animate-fade-up delay-700">
          ...
          <div className="bento-item wide animate-fade-up delay-400">
